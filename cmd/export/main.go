...
import (
	...
	"github.com/mainflux/export/export"
	"github.com/mainflux/export/export/api"
	exmqtt "github.com/mainflux/export/export/mqtt"
...
func main() {
	...
	w := export.New(nc, repo, nil, cfg.Channels, nil, logger)
